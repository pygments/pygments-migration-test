...
class EmacsLispLexer(RegexLexer):
    ...
    builtin_function = {
        ...
        'file-system-info', 'file-writable-p',
        ...
        'x-close-connection',
        'x-create-frame', 'x-delete-window-property', 'x-disown-selection-internal', 'x-display-backing-store',
        'x-display-color-cells',
        'x-display-grayscale-p',
        'x-display-list', 'x-display-mm-height', 'x-display-mm-width',
        'x-display-monitor-attributes-list',
        'x-display-pixel-height', 'x-display-pixel-width', 'x-display-planes',
        'x-display-save-under', 'x-display-screens', 'x-display-visual-class',
        'x-family-fonts', 'x-file-dialog',
        'x-focus-frame', 'x-frame-geometry',
        'x-get-atom-name', 'x-get-resource',
        'x-get-selection-internal', 'x-hide-tip', 'x-list-fonts', 'x-load-color-file', 'x-menu-bar-open-internal',
        'x-open-connection', 'x-own-selection-internal', 'x-parse-geometry', 'x-popup-dialog',
        'x-popup-menu', 'x-register-dnd-atom', 'x-select-font',
        'x-selection-exists-p', 'x-selection-owner-p',
        'x-send-client-message', 'x-server-max-request-size',
        'x-server-vendor', 'x-server-version', 'x-show-tip', 'x-synchronize', 'x-uses-old-gtk-dialog',
        'x-window-property', 'x-wm-set-size-hint',
        'xw-color-defined-p', 'xw-color-values',
        'xw-display-color-p', 'yes-or-no-p', 'zlib-available-p', 'zlib-decompress-region',
        'forward-point'
    }
